...
This source is the API-backed companion to `zh.exmirror` v12. Keep v12 available as the HTML-listing fallback. The API source uses EXMirror JSON endpoints for list pages:
